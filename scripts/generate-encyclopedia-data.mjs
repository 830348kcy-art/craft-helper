...
const mobs = [
  // ── 오버월드 · 친화적 ──
  { id: "bat", name: "박쥐", dimension: "overworld", emoji: "🦇", category: "친화적", health: 6, drops: [], spawn: "동굴·폐광(밝기 3 이하)", traits: "벽에 매달려 휴식. 플레이어를 공격하지 않음.", description: "어두운 동굴에서 날아다니는 작은 몹. 경험치는 거의 없다." },
  { id: "chicken", name: "닭", dimension: "overworld", emoji: "🐔", category: "친화적", health: 4, drops: ["feather", "chicken", "egg"], spawn: "잔디 블록, 밝기 9 이상", traits: "알을 낳음. 낙하 시 날개 펄럭여 피해 감소.", description: "초반 식량·깃털 공급원." },
  { id: "cow", name: "소", dimension: "overworld", emoji: "🐄", category: "친화적", health: 10, drops: ["leather", "beef"], spawn: "잔디 블록, 밝기 9 이상", traits: "번식: 밀 2개. 우유 양동이로 채집.", description: "가죽·음식·책장 제작의 기본 공급원." },
  { id: "pig", name: "돼지", dimension: "overworld", emoji: "🐷", category: "친화적", health: 10, drops: ["porkchop"], spawn: "잔디 블록", traits: "당근으로 유인·번식. 안장+지팡이로 탑승.", description: "초반 식량·번식용." },
  { id: "sheep", name: "양", dimension: "overworld", emoji: "🐑", category: "친화적", health: 8, drops: ["wool", "mutton"], spawn: "잔디 블록", traits: "가위로 양털 채취(양 생존). 밀로 번식.", description: "침대 제작에 양털이 필수." },
  { id: "horse", name: "말", dimension: "overworld", emoji: "🐴", category: "친화적", health: 30, drops: ["leather"], spawn: "평원·사바나", traits: "길들이기·안장·갑옷 착용. 점프력·속도 능력치 다양.", description: "이동 수단으로 유용." },
  { id: "donkey", name: "당나귀", dimension: "overworld", emoji: "🫏", category: "친화적", health: 30, drops: ["leather"], spawn: "평원(말과 함께)", traits: "상자 부착 가능. 말보다 느리지만 짐 운반.", description: "소형 이동 창고." },
  { id: "rabbit", name: "토끼", dimension: "overworld", emoji: "🐇", category: "친화적", health: 3, drops: ["rabbit", "rabbit_hide", "rabbit_foot"], spawn: "사막·타이가·설원", traits: "당근·황금 당근으로 번식. 희귀 발 발톱 드롭.", description: "사막·눈 바이옴에서 흔함." },
  { id: "squid", name: "오징어", dimension: "overworld", emoji: "🦑", category: "친화적", health: 10, drops: ["ink_sac"], spawn: "바다·강", traits: "피해 시 먹물 방출. 수중 호흡.", description: "먹물·검은 염료 제작 재료." },
  { id: "glow_squid", name: "발광 오징어", dimension: "overworld", emoji: "✨", category: "친화적", health: 10, drops: ["glow_ink_sac"], spawn: "깊은 바다·동굴 수중", traits: "발광 먹물 방출. 어둠 속 시야 확보.", description: "발광 표지판·발광 아이템 프레임에 사용." },
  { id: "cod", name: "대구", dimension: "overworld", emoji: "🐟", category: "친화적", health: 3, drops: ["cod"], spawn: "일반·차가운 바다", traits: "물 속에서만 생존. 물고기 양동이에 담을 수 있음.", description: "생선 음식·거래 재료." },
  { id: "salmon", name: "연어", dimension: "overworld", emoji: "🐟", category: "친화적", health: 3, drops: ["salmon"], spawn: "강·한대·냉대 바다", traits: "위로 헤엄치는 특유의 움직임.", description: "강가 낚시·식량." },
  { id: "tropical_fish", name: "열대어", dimension: "overworld", emoji: "🐠", category: "친화적", health: 3, drops: ["tropical_fish"], spawn: "따뜻한·온대 바다", traits: "다양한 색 패턴. 물고기 양동이에 담아 수족관.", description: "장식용 물고기." },
  { id: "turtle", name: "거북", dimension: "overworld", emoji: "🐢", category: "친화적", health: 30, drops: ["seagrass"], spawn: "해변(모래 위)", traits: "알 부화. 성체는 가죽·등딱지 드롭.", description: "거북 등딱지(호흡 연장) 획득." },
  { id: "cat", name: "고양이", dimension: "overworld", emoji: "🐱", category: "친화적", health: 10, drops: [], spawn: "마을·늪 오두막", traits: "생선·생연어로 길들임. 크리퍼·팬텀 겁줌.", description: "마을 방어·애완용." },
  { id: "ocelot", name: "오실롯", dimension: "overworld", emoji: "🐆", category: "친화적", health: 10, drops: [], spawn: "정글", traits: "생선으로 유인. 크리퍼 회피.", description: "정글에서 길들여 고양이로 전환." },
  { id: "parrot", name: "앵무새", dimension: "overworld", emoji: "🦜", category: "친화적", health: 6, drops: ["feather"], spawn: "정글", traits: "씨앗·쿠키로 긴들임. 플레이어 어깨에 앉음. 소리 모방.", description: "정글 탐험 시 동반자." },
  { id: "panda", name: "판다", dimension: "overworld", emoji: "🐼", category: "친화적", health: 20, drops: ["bamboo"], spawn: "대나무 정글", traits: "대나무·케이크 번식. 성격(보통·게으름·걱정)에 따라 행동 다름.", description: "대나무 정글 전용." },
  { id: "fox", name: "여우", dimension: "overworld", emoji: "🦊", category: "친화적", health: 10, drops: ["sweet_berries"], spawn: "타이가·눈 타이가", traits: "달콤한 열매로 번식. 밤에 닭·토끼 사냥.", description: "타이가 생태계의 포식자." },
  { id: "axolotl", name: "아홀로틀", dimension: "overworld", emoji: "🦎", category: "친화적", health: 14, drops: [], spawn: "늪 지하 동굴 수중", traits: "버킷에 담아 이동. 플레이어 대신 적 공격.", description: "수중 전투 보조." },
  { id: "frog", name: "개구리", dimension: "overworld", emoji: "🐸", category: "친화적", health: 10, drops: [], spawn: "늪", traits: "올챙이로 번식. 슬라임볼·마그마 큐브를 구슬로 변환.", description: "온대·따뜻·추운 개구리 색 변종." },
  { id: "allay", name: "알레이", dimension: "overworld", emoji: "🧚", category: "친화적", health: 20, drops: [], spawn: "약탈자 전초기지 감옥", traits: "아이템 수집·전달. 노트 블록 소리에 반응.", description: "자동화·정렬에 활용." },
  { id: "sniffer", name: "스니퍼", dimension: "overworld", emoji: "🦕", category: "친화적", health: 14, drops: ["torchflower_seeds"], spawn: "스니퍼 알 부화", traits: "땅을 파서 고대 씨앗 발굴.", description: "1.20 고대 식물 복원." },
  { id: "camel", name: "낙타", dimension: "overworld", emoji: "🐫", category: "친화적", health: 32, drops: [], spawn: "사막 마을", traits: "두 명 동시 탑승. 긴 점프.", description: "사막 이동 수단." },
  { id: "villager", name: "주민", dimension: "overworld", emoji: "🧑‍🌾", category: "친화적", health: 20, drops: [], spawn: "마을·인공 주민 생성기", traits: "직업·거래. 좀비 주민 치료 가능.", description: "에메랄드 거래로 장비·식량 확보." },
  { id: "wandering_trader", name: "떠돌이 상인", dimension: "overworld", emoji: "🧳", category: "친화적", health: 20, drops: [], spawn: "플레이어 근처(랜덤)", traits: "에메랄드로 희귀 식물·블록 거래. 라마 동반.", description: "난 씨앗·삼나무 묘목 등 구매." },
  { id: "iron_golem", name: "철 골렘", dimension: "overworld", emoji: "🤖", category: "친화적", health: 100, drops: ["iron_ingot", "poppy"], spawn: "마을(주민 수 충족)·플레이어 제작", traits: "주민 보호. 플레이어가 만든 골렘은 중립.", description: "마을 방어·철 공급." },
  { id: "snow_golem", name: "눈 골렘", dimension: "overworld", emoji: "⛄", category: "친화적", health: 4, drops: ["snowball"], spawn: "플레이어 제작(눈+호박)", traits: "눈덩이 투척. 더운 바이옴에서 녹음.", description: "장식·소형 방어." },
  // ── 오버월드 · 중립 ──
  ...
  { id: "dolphin", name: "돌고래", dimension: "overworld", emoji: "🐬", category: "친화적", health: 10, drops: ["cod"], spawn: "따뜻한·온대 바다", traits: "플레이어 수영 가속. 생선 먹이.", description: "해상 이동 보조." },
  ...
  { id: "strider", name: "스트라이더", dimension: "nether", emoji: "🦵", category: "친화적", health: 20, drops: ["string"], spawn: "용암 위", traits: "뒤틀린 버섯 낚싯대로 탑승·유인.", description: "용암 위 이동 수단." },
