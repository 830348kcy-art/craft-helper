...
> = {
  blocks: {
    blockCats: ["자연", "건축", "특수", "나무", "광석", "네더", "엔드", "기능", "레드스톤", "장식", "조명", "자원", "식물", "이동"],
  },
  items: {
    itemCats: ["자원", "연료", "재료", "특수", "마법", "농작물", "음식", "무기", "탄약", "방어구", "도구", "보관", "기타", "음악", "이동", "크리에이티브", "양조"],
    recipeCats: ["도구", "무기", "방어구", "음식", "재료", "기본", "기능", "레드스톤", "이동", "건축", "장식", "조명"],
  },
  mobs: {
    // 몹 관련 (드롭 아이템·알 등)
