  ...
  "getting-started": {
    ...
    sections: [
      ...
      },
      {
        id: "night",
        heading: "5. 첫 밤 넘기기",
        html: `<p>침대가 없다면 쉘터 안에서 그냥 시간을 보내면 된다. 추천 활동:</p><ul><li>둥근돌을 더 많이 채굴해서 자원 확보</li><li>인벤토리 정리 및 상자 분류</li><li>다음 날 계획 (석탄 광석, 철 광석 찾기)</li></ul><p>침대를 만들고 싶다면 <strong>양털 3개 + 판자 3개</strong>가 필요하다. 양은 검으로 잡아도 양털이 드롭되며, 가위로 깎으면 양을 죽이지 않고 1~3개를 얻을 수 있다.</p>`,
      },
    ],
  },
  "nether-portal": {
